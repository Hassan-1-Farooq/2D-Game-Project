...
//            coffee = ImageIO.read(new File("assets/coffee.png"));
//            assert coffee.getHeight() == GameGUI.TILE_HEIGHT
//                    && coffee.getWidth() == GameGUI.TILE_WIDTH;
                ...
                for (int j = 0; j < currentTiles[i].length; j++) {
                    switch (currentTiles[i][j]) {
                        ...
                        case DOOR:
                            ...
                            break;
//                        case coffee:
//                            g2.drawImage(coffee, i * GameGUI.TILE_WIDTH, j * GameGUI.TILE_HEIGHT, null);
//                            break;
                        case TABLE:
                            g2.drawImage(floor1, i * GameGUI.TILE_WIDTH, j * GameGUI.TILE_HEIGHT, null);
